...
export default class GetGstr3bDetails extends React.Component<any, any> {
  ...
  constructor(props, _railsContext) {
    ...
    this.state = {
      ...
      gstr3b_details_url: this.props.gstr3b_details_url,
      gstr3b_response: {},
      loader: false
    };
  }
  ...
  handleSubmit = (event) => {
    const method = "POST";
    const hostname = this.state.gstr3b_details_url;
    ...
    return (
      <div>
        ...
        <form onSubmit={this.handleSubmit} >
          ...
          <input type='submit' className='btn btn-default' value='GSTR3B Details' />
        </form>
        Response:
